...
public class Staff extends User {
        ...
        switch (choice) {
            ...
            case 5:
                ...
                if (tries >= MAX_TRIES) {
                    ...
                    System.out.println(
                            "The Camp User Group has changed to " + selectedCamp.getCampInfo().getCampUserGroup().toString());
                    return true;
                }
            ...
            case 6:
                ...
                if (tries >= MAX_TRIES) {
                    ...
                    System.out.println(
                            "The Camp Visibility has changed to " + selectedCamp.getCampInfo().getCampVisibility().toString());
                    return true;
                }
    ...
    public boolean deleteCamp(ArrayList<Camp> allCamps) {
        ...
        if (camp.getRegisteredStudents().isEmpty()) { // Only can delete the empty camp
            ...
            System.out.println("Camp "+camp.getCampInfo().getCampName()+" has been deleted.");
            return true;
        } else {
